class Views::Pages::Policies::DataDeletion < Views::Base
  def view_template
    div(class: "p-10") do
      ...
      # 개요 섹션
      div(class: "mb-8") do
        h2(class: "mb-4 text-xl font-semibold") { "개요" }
        p(class: "mb-4 text-sm") do
      ...
      # 계정 및 데이터 삭제 방법 섹션
      div(class: "mb-8") do
        h2(class: "mb-4 text-xl font-semibold") { "계정 및 데이터 삭제 방법" }
        p(class: "mb-2 text-sm") { "사용자는 다음 방법 중 하나를 통해 계정 및 개인 데이터 삭제를 요청할 수 있습니다:" }

        # 앱 내에서 삭제
        h3(class: "mt-4 mb-2 text-xl font-semibold") { "1. 앱 내에서 삭제" }
        ol(class: "pl-6 mb-4 list-decimal text-sm") do
          li { "포토게더 앱에 로그인합니다." }
          li { "설정 메뉴로 이동합니다." }
          li { "'계정 관리'를 선택합니다." }
          li { "'계정 삭제'를 탭합니다." }
      ...
      # 삭제되는 데이터 섹션
      div(class: "mb-8") do
        h2(class: "mb-4 text-xl font-semibold") { "삭제되는 데이터" }
        p(class: "mb-2") { "계정 삭제 시 다음 데이터가 영구적으로 삭제됩니다:" }
        ul(class: "pl-6 mb-4 list-disc text-sm") do
      ...
      # 데이터 보관 섹션
      div(class: "mb-8") do
        h2(class: "mb-4 text-xl font-semibold") { "데이터 보관" }
      ...
      # 삭제 처리 기간 섹션
      div(class: "mb-8") do
        h2(class: "mb-4 text-xl font-semibold") { "삭제 처리 기간" }
        p(class: "mb-4 text-sm") do
