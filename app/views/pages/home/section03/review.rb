class Views::Pages::Home::Section03::Review < Views::Base
  ...
  def view_template
    div(class: "border border-primary rounded-[20px] p-[24px] w-[323px] h-[246px]") do
      div(class: "flex items-center gap-[12px]") do
        div do
          img(src: "/images/landing/section03/item02.png", class: "w-[60px] h-[60px]")
        end
        div do
          h2(class: "text-xl") { @reviewer }
      ...
      # 4줄로 조정하는 예시
      div(class: "text-[#C6C6C6] text-sm mt-[12px] h-[126px] tracking-normal leading-[150%] overflow-hidden") do
