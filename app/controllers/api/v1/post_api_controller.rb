class Api::V1::PostApiController < Api::ApplicationApiController
  ...
  def index
    ...
    render json: {
      ...
      items: posts.map { |post| post_with_image_urls(post) }
    }, status: :ok
  end
  ...
  def destroys
    ...
    trash_collection = find_or_create_trash_collection
